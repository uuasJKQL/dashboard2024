...
#include "stdlib.h"  
//////////////////////////////////////////////////////////////////////////////////	 
extern const unsigned char gImage_School_Badge[180008];
extern const unsigned char gImage_ERacing[35200];
...
void LCD_ShowFloat(u16 point_x,u16 point_y,float num,u8 decimal_len,u8 size);
void LCD_ShowInt(u16 x,u16 y,u16 num,u8 len,u8 size);
void LCD_Show_Chinese(u16 x,u16 y,u8 *num,u8 size,u8 mode);
void LCD_Show_Chinese_String(u16 x,u16 y,u16 width,u16 height,u8 size,u8 *p);
void LCD_Show_ERacing(void);
void LCD_Show_School_Badge(void);
